...
export const theme: DesignTokens = {
  ...
  components: {
    ...
    select: {
      ...
      'select-input-placeholder-color': themeColors.gray['200'],
      ...
      'select-chip-background': themeColors.gray['600'],
      'select-chip-border': `solid 1px ${themeColors.gray['300']}`,
      'select-chip-border-radius': borders.radius.md,
