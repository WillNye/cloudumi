(() => {
  ...
  var on = (e, t, r) =>
      t in e
        ...
        : (e[t] = r),
    $ = (e, t) => {
      for (var r in t || (t = {})) Sr.call(t, r) && on(e, r, t[r]);
      if (Ct) for (var r of Ct(t)) an.call(t, r) && on(e, r, t[r]);
      return e;
    };
  var sn = (e, t) => {
    var r = {};
    ...
    if (e != null && Ct)
      for (var n of Ct(e)) t.indexOf(n) < 0 && an.call(e, n) && (r[n] = e[n]);
    return r;
  };
  var bt = (e, t) => () => (
    ...
    if ((t && typeof t == "object") || typeof t == "function")
      for (let o of na(t))
        !Sr.call(e, o) &&
          ...
          xr(e, o, {
            get: () => t[o],
            enumerable: !(n = ra(t, o)) || n.enumerable,
          });
    return e;
  };
  var Ke = (e, t, r) => (
      ...
      function e(r) {
        ...
        function c(_) {
          var je = _.type,
            de = _.tagName;
          return !!(
            (de === "INPUT" && a[je] && !_.readOnly) ||
            (de === "TEXTAREA" && !_.readOnly) ||
            _.isContentEditable
          );
        }
        function u(_) {
        ...
        function p(_) {
          _.metaKey ||
            _.altKey ||
            _.ctrlKey ||
            (s(r.activeElement) && u(r.activeElement), (n = !0));
        }
        function l(_) {
          n = !1;
        }
        function d(_) {
          !s(_.target) || ((n || c(_.target)) && u(_.target));
        }
        function h(_) {
          !s(_.target) ||
      ...
      var t = function () {
        ...
        s = function () {
          try {
            ...
            return (
              new u("?a=1").toString() === "a=1" &&
              typeof u.prototype.set == "function" &&
              typeof u.prototype.entries == "function"
            );
          } catch (f) {
            return !1;
          }
      ...
      typeof c.sort != "function" &&
        (c.sort = function () {
          var u = this,
            f = [];
          this.forEach(function (l, d) {
            f.push([d, l]), u._entries || u.delete(d);
          }),
            f.sort(function (l, d) {
              return l[0] < d[0] ? -1 : l[0] > d[0] ? 1 : 0;
            }),
            u._entries && (u._entries = {});
          for (var p = 0; p < f.length; p++) this.append(f[p][0], f[p][1]);
        }),
          ...
          Object.defineProperty(c, "_fromString", {
            ...
            value: function (u) {
              if (this._entries) this._entries = {};
                ...
                for (var p = 0; p < f.length; p++) this.delete(f[p]);
              }
              u = u.replace(/^\?/, "");
              for (var l = u.split("&"), d, p = 0; p < l.length; p++)
                (d = l[p].split("=")),
          ...
          var o = e.URL,
            i = function (c, u) {
              ...
              if (u && (e.location === void 0 || u !== e.location.href)) {
                ...
                try {
                  if (p.href.indexOf(u) !== 0) throw new Error(p.href);
                } catch (_) {
                  throw new Error(
                    "URL unable to set base " + u + " due to " + _
                  );
                }
              }
              var l = f.createElement("a");
              (l.href = c), p && (f.body.appendChild(l), (l.href = l.href));
...
***************************************************************************** */ var pn,
    ...
    (function (e) {
      ...
      typeof define == "function" && define.amd
        ...
        : typeof Ht == "object" && typeof Ht.exports == "object"
        ? e(r(t, r(Ht.exports)))
        : e(r(t));
      function r(n, o) {
        return (
      ...
      (pn = function (n, o) {
        ...
        (vn = function (n, o, i, a) {
          ...
          return new (i || (i = Promise))(function (c, u) {
            ...
            function l(d) {
              d.done ? c(d.value) : s(d.value).then(f, p);
            }
        ...
        (Sn = function () {
          ...
          for (var a = Array(n), s = 0, o = 0; o < i; o++)
            for (var c = arguments[o], u = 0, f = c.length; u < f; u++, s++)
              a[s] = c[u];
          return a;
        }),
        (wn = function (n, o, i) {
        ...
        (En = function (n, o, i) {
          ...
          function h(b, F) {
            b(F), c.shift(), c.length && f(c[0][0], c[0][1]);
          }
        }),
        (On = function (n) {
          var o, i;
        ...
        (_n = function (n) {
          ...
          return o
            ? o.call(n)
            : ((n = typeof Rt == "function" ? Rt(n) : n[Symbol.iterator]()),
              (i = {}),
              a("next"),
              a("throw"),
              a("return"),
      ...
      (Mn = function (n) {
        ...
        e("__spreadArray", wn),
        e("__await", tt),
        e("__asyncGenerator", En),
        e("__asyncDelegator", On),
        e("__asyncValues", _n),
        e("__makeTemplateObject", Tn),
        e("__importStar", Mn),
        e("__importDefault", Ln),
        e("__classPrivateFieldGet", An),
        e("__classPrivateFieldSet", Cn);
    });
  });
  var Yr = bt((Tt, Kr) => {
    /*!
     ...
     */ (function (t, r) {
      typeof Tt == "object" && typeof Kr == "object"
        ? (Kr.exports = r())
        : typeof define == "function" && define.amd
        ? define([], r)
        : typeof Tt == "object"
      ...
      return (function () {
        var e = {
            686: function (n, o, i) {
              ...
              function b(I) {
                ...
                (w.style.fontSize = "12pt"),
                  ...
                  (w.style[M ? "right" : "left"] = "-9999px");
                var W =
                  window.pageYOffset || document.documentElement.scrollTop;
                return (
                  (w.style.top = "".concat(W, "px")),
              ...
              var _ = function () {
                  ...
                  if (N !== void 0)
                    if (N && U(N) === "object" && N.nodeType === 1) {
                      if (W === "copy" && N.hasAttribute("disabled"))
                        throw new Error(
                  ...
                  if (Oe) return K(Oe, { container: R });
                  if (N) return W === "cut" ? h(N) : K(N, { container: R });
                },
                je = _;
              function de(I) {
                return (
              ...
              function Ki(I, M, w) {
                return M && nn(I.prototype, M), w && nn(I, w), I;
              }
              function Yi(I, M) {
              ...
              function Bi(I) {
                ...
                return function () {
                  ...
                  if (M) {
                    ...
                    R = Reflect.construct(W, arguments, N);
                  } else R = W.apply(this, arguments);
                  return Gi(this, R);
                };
              }
              function Gi(I, M) {
                return M && (de(M) === "object" || typeof M == "function")
                  ? M
                  : Ji(I);
              }
              function Ji(I) {
              ...
              function yr(I, M) {
                var w = "data-clipboard-".concat(I);
                if (!!M.hasAttribute(w)) return M.getAttribute(w);
              }
              var Zi = (function (I) {
                  Yi(w, I);
                  var M = Bi(w);
                    ...
                    Ki(
                      ...
                      [
                        ...
                        },
                        {
                          ...
                          value: function (R) {
                            var N = this;
                            this.listener = u()(R, "click", function (Oe) {
                              return N.onClick(Oe);
                            });
                          },
                        },
                        {
                          key: "onClick",
                          value: function (R) {
                            var N = R.delegateTarget || R.currentTarget,
                              Oe = this.action(N) || "copy",
                              At = je({
                                action: Oe,
                          ...
                          value: function () {
                            ...
                            return (
                              N.forEach(function (At) {
                                Oe = Oe && !!document.queryCommandSupported(At);
                              }),
                              Oe
                            );
                          },
            ...
            438: function (n, o, i) {
              var a = i(828);
              function s(f, p, l, d, h) {
                var b = u.apply(this, arguments);
                return (
                  f.addEventListener(l, b, h),
                  {
                    destroy: function () {
                      f.removeEventListener(l, b, h);
                    },
                  }
                );
              }
              function c(f, p, l, d, h) {
                return typeof f.addEventListener == "function"
                  ...
                  : (typeof f == "string" && (f = document.querySelectorAll(f)),
                    Array.prototype.map.call(f, function (b) {
                      return s(b, p, l, d, h);
                    }));
              }
              function u(f, p, l, d) {
            ...
            370: function (n, o, i) {
              ...
              function c(l, d, h) {
                ...
                if (a.node(l)) return u(l, d, h);
                if (a.nodeList(l)) return f(l, d, h);
            ...
            279: function (n) {
              ...
              (o.prototype = {
                ...
                once: function (i, a, s) {
                  var c = this;
                  function u() {
                    c.off(i, u), a.apply(s, arguments);
                  }
                  return (u._ = a), this.on(i, u, s);
                },
                emit: function (i) {
                  var a = [].slice.call(arguments, 1),
                    ...
                    c = 0,
                    u = s.length;
                  for (c; c < u; c++) s[c].fn.apply(s[c].ctx, a);
                  return this;
                },
                off: function (i, a) {
                  var s = this.e || (this.e = {}),
                  ...
                  if (c && a)
                    for (var f = 0, p = c.length; f < p; f++)
                      c[f].fn !== a && c[f].fn._ !== a && u.push(c[f]);
                  return u.length ? (s[i] = u) : delete s[i], this;
                },
              }),
                (n.exports = o),
  ...
  var kn = Ke(Rn(), 1),
    {
      ...
      __importStar: Js,
      __importDefault: Xs,
      __classPrivateFieldGet: Zs,
      __classPrivateFieldSet: ec,
    } = kn.default;
  function E(e) {
...
` +
      ...
      (e.prototype.unsubscribe = function () {
        ...
        if (!this.closed) {
          ...
          if (p) {
            this._finalizers = null;
            try {
              for (var l = he(p), d = l.next(); !d.done; d = l.next()) {
                var h = d.value;
                try {
                  $n(h);
                } catch (b) {
  ...
  var rt = {
    setTimeout: function (e, t) {
      ...
      return o != null && o.setTimeout
        ? o.setTimeout.apply(o, D([e, t], j(r)))
        : setTimeout.apply(void 0, D([e, t], j(r)));
    },
  ...
  var vt = (function (e) {
    ...
    function t(r) {
      ...
      return (
        (n.isStopped = !1),
        r ? ((n.destination = r), Ft(r) && r.add(n)) : (n.destination = ua),
        n
      );
    }
    return (
      ...
      (t.prototype.next = function (r) {
        this.isStopped ? Lr(Un(r), this) : this._next(r);
      }),
  ...
  var aa = Function.prototype.bind;
  function Mr(e, t) {
    return aa.call(e, t);
  }
  var sa = (function () {
    ...
    ot = (function (e) {
      ...
      function t(r, n, o) {
        ...
        return (i.destination = new sa(a)), i;
      }
      return t;
    })(vt);
  function Wt(e) {
    _e.useDeprecatedSynchronousErrorHandling ? Wn(e) : Ut(e);
  }
  function ca(e) {
    throw e;
  }
  ...
  var ua = { closed: !0, next: fe, error: ca, complete: fe };
  var it = (function () {
  ...
  function pa(e) {
    return (e && e instanceof vt) || (fa(e) && Ft(e));
  }
  function la(e) {
  ...
  var xt = {
    setInterval: function (e, t) {
      ...
      return o != null && o.setInterval
        ? o.setInterval.apply(o, D([e, t], j(r)))
        : setInterval.apply(void 0, D([e, t], j(r)));
    },
  ...
  var Dt = (function (e) {
    ...
    return (
      ...
      (t.prototype.requestAsyncId = function (r, n, o) {
        return (
          o === void 0 && (o = 0), xt.setInterval(r.flush.bind(r, this), o)
        );
      }),
  ...
  function Fe(e) {
    return E(kr(e)) ? e.pop() : void 0;
  }
  function ye(e) {
    return Nt(kr(e)) ? e.pop() : void 0;
  }
  function zt(e, t) {
  ...
  function xa(e, t) {
    ...
    return Hn(this, void 0, void 0, function () {
      ...
      return Pt(this, function (c) {
        switch (c.label) {
          case 0:
            c.trys.push([0, 5, 6, 11]), (r = In(e)), (c.label = 1);
          case 1:
            return [4, r.next()];
          case 2:
  ...
  function eo(e, t) {
    if (e != null) {
      ...
      if (st(e)) return Jn(e, t);
      if (qt(e)) return Gn(e, t);
      if (Kt(e)) return er(e, t);
      if (Gt(e)) return Xn(e, t);
  ...
  function wa(e, t) {
    return Sa(t) ? e.apply(void 0, D([], j(t))) : e(t);
  }
  function Ue(e) {
    return m(function (t) {
      return wa(e, t);
  ...
  function Ma(e) {
    return e && typeof e == "object" && Oa(e) === _a;
  }
  function no(e, t) {
  ...
  function io(e, t, r, n, o, i, a, s) {
    var c = [],
      u = 0,
      f = 0,
      p = !1,
      l = function () {
        p && !c.length && !u && t.complete();
      },
      d = function (b) {
        return u < n ? h(b) : c.push(b);
      },
      h = function (b) {
        i && t.next(b), u++;
        var F = !1;
  ...
  var La = ["addListener", "removeListener"],
    Aa = ["addEventListener", "removeEventListener"],
    Ca = ["on", "off"];
  function y(e, t, r, n) {
    if ((E(r) && ((n = r), (r = void 0)), n)) return y(e, t, r).pipe(Ue(n));
    var o = j(
        Ha(e)
          ? Aa.map(function (s) {
              return function (c) {
  ...
  function C() {
    ...
    var r = ye(e),
      n = zt(e, 1 / 0),
      o = e;
    return o.length ? (o.length === 1 ? V(o[0]) : ct(n)(ne(o, r))) : z;
  }
  var xe = new k(fe);
    ...
    return v(function (t, r) {
      ...
      t.subscribe(
        g(
          r,
          function (u) {
            (n = !0), (o = u), i || V(e(u)).subscribe((i = g(r, s, c)));
          },
          function () {
        ...
        r.subscribe(
          g(
            ...
            function (a) {
              ...
              i++ % t === 0 && o.push([]);
              try {
                for (var l = he(o), d = l.next(); !d.done; d = l.next()) {
                  var h = d.value;
                  h.push(a),
              ...
              if (p)
                try {
                  for (var b = he(p), F = b.next(); !F.done; F = b.next()) {
                    var h = F.value;
                    ke(o, h), n.next(h);
                  }
                } catch (K) {
      ...
      v(function (r, n) {
        ...
        r.subscribe(
          g(
            n,
            function (u) {
              (i = u), (a = t.now()), o || ((o = t.schedule(c, e)), n.add(o));
            },
            function () {
              s(), n.complete();
            },
  ...
  function jr(e, t) {
    return t
      ? function (r) {
          return Ge(t.pipe(re(1), fo()), r.pipe(jr(e)));
        }
      : ie(function (r, n) {
          return e(r, n).pipe(re(1), Z(r));
        });
  }
  function Ie(e, t) {
    t === void 0 && (t = ge);
  ...
  function rr() {
    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    return function (r) {
      return Ge(r, H.apply(void 0, D([], j(e))));
    };
  }
  function L(e) {
    return v(function (t, r) {
  ...
  function po() {
    ...
    return (
      (e = ut(e)),
      v(function (o, i) {
        ct(n)(ne(D([o], j(e)), r)).subscribe(i);
      })
    );
  }
  function Xe() {
    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    return po.apply(void 0, D([], j(e)));
  }
  function wt(e) {
    var t,
      r = 1 / 0,
            ...
            var a = 0,
              ...
              c = function () {
                if ((s == null || s.unsubscribe(), (s = null), n != null)) {
                  var f = typeof n == "number" ? We(n) : V(n(a)),
                    p = g(i, function () {
                      p.unsubscribe(), u();
                    });
                  f.subscribe(p);
        ...
        je.add(function () {
          ...
          f ||
            ((f = new ot({
              ...
              error: function (et) {
                (b = !0), F(), (p = Ur(K, o, et)), de.error(et);
              },
              complete: function () {
                (h = !0), F(), (p = Ur(K, a)), de.complete();
              },
            })),
            ne(_).subscribe(f));
      })(u);
  ...
  function S(e, t, r) {
    var n = E(e) || t || r ? { next: e, error: t, complete: r } : e;
    return n
      ? v(function (o, i) {
          var a;
          ...
          o.subscribe(
            g(
              ...
              function (c) {
                var u;
                (u = n.next) === null || u === void 0 || u.call(n, c),
                  i.next(c);
              },
              function () {
                var c;
    ...
    return (
      ...
      v(function (r, n) {
        var o = t.leading,
          ...
          l = function (h) {
            return (c = V(e(h)).subscribe(g(n, f, p)));
          },
          d = function () {
            if (a) {
              a = !1;
              var h = s;
              (s = null), n.next(h), !u && l(h);
            }
          };
        r.subscribe(
          g(
  ...
  function Nr() {
    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    return lo.apply(void 0, D([], j(e)));
  }
  function mo() {
    let e = new yt(1);
    return (
      y(document, "DOMContentLoaded", { once: !0 }).subscribe(() =>
        e.next(document)
      ),
      e
    );
  ...
  function nr(e) {
    return C(y(document.body, "focusin"), y(document.body, "focusout")).pipe(
      Je(1),
      m(() => {
        let t = Ne();
  ...
  function ho(e) {
    return C(y(window, "load"), y(window, "resize")).pipe(
      He(0, Te),
      m(() => ze(e)),
      q(ze(e))
    );
  ...
  function or(e) {
    return C(y(e, "scroll"), y(window, "resize")).pipe(
      He(0, Te),
      m(() => bo(e)),
      q(bo(e))
    );
  ...
  var Ua = 20,
    ...
    Da = typeof MutationObserver != "undefined",
    Va = (function () {
      function e() {
        (this.connected_ = !1),
          ...
          (this.refresh = Fa(this.refresh.bind(this), Ua));
      }
      return (
  ...
  function qa(e) {
    ...
    if (
      (n.boxSizing === "border-box" &&
        (Math.round(s + i) !== t && (s -= vo(n, "left", "right") + i),
        Math.round(c + a) !== r && (c -= vo(n, "top", "bottom") + a)),
      !Ka(e))
    ) {
  ...
  var Qa = (function () {
    return typeof SVGGraphicsElement != "undefined"
      ...
      : function (e) {
          return (
            e instanceof pt(e).SVGElement && typeof e.getBBox == "function"
          );
        };
  })();
  function Ka(e) {
  ...
  var Ga = (function () {
    ...
    Ja = (function () {
      function e(t, r) {
        var n = Ba(r);
        yo(this, { target: t, contentRect: n });
      }
      return e;
    })(),
    Xa = (function () {
    ...
    So = typeof WeakMap != "undefined" ? new WeakMap() : new go(),
    wo = (function () {
      function e(t) {
  ...
  var Za = (function () {
      return typeof ir.ResizeObserver != "undefined" ? ir.ResizeObserver : wo;
    })(),
    Eo = Za;
  var Oo = new O(),
    es = P(() =>
      H(
        new Eo((e) => {
          for (let t of e) Oo.next(t);
        })
      )
    ).pipe(
      x((e) => C(xe, H(e)).pipe(L(() => e.disconnect()))),
      X(1)
    );
  function Ce(e) {
  ...
  function Ao() {
    return y(window, "keydown").pipe(
      T((e) => !(e.metaKey || e.ctrlKey)),
      m((e) => ({
      ...
      T(({ mode: e, type: t }) => {
        if (e === "global") {
          let r = Ne();
          if (typeof r != "undefined") return !rs(r, t);
        }
        return !0;
      }),
      ae()
  ...
  function ns() {
    return y(window, "hashchange").pipe(
      m(Ho),
      q(Ho()),
      T((e) => e.length > 0),
      X(1)
  ...
  function Io() {
    return ns().pipe(
      m((e) => ue(`[id="${e}"]`)),
      T((e) => typeof e != "undefined")
    );
  }
  function qr(e) {
    let t = matchMedia(e);
    return tr((r) => t.addListener(() => r(t.matches))).pipe(q(t.matches));
  }
  function $o() {
    let e = matchMedia("print");
    return C(
      y(window, "beforeprint").pipe(Z(!0)),
      y(window, "afterprint").pipe(Z(!1))
    ).pipe(q(e.matches));
  }
  function Qr(e, t) {
    return e.pipe(x((r) => (r ? t() : z)));
  }
  function lr(e, t = { credentials: "same-origin" }) {
    return ne(fetch(`${e}`, t)).pipe(
      T((r) => r.status === 200),
      De(() => z)
    );
  }
    ...
    return P(
      () => (
        ...
        C(
          y(t, "load"),
          y(t, "error").pipe(
            x(() => Hr(() => new ReferenceError(`Invalid script: ${e}`)))
          )
        ).pipe(
          Z(void 0),
  ...
  function Wo() {
    return C(
      y(window, "scroll", { passive: !0 }),
      y(window, "resize", { passive: !0 })
    ).pipe(m(Uo), q(Uo()));
  }
  function Do() {
  ...
  function Vo() {
    return y(window, "resize", { passive: !0 }).pipe(m(Do), q(Do()));
  }
  function No() {
    return B([Wo(), Vo()]).pipe(
  ...
  function mr(e, { viewport$: t, header$: r }) {
    let n = t.pipe(J("size")),
      o = B([n, r]).pipe(m(() => ze(e)));
    return B([r, t, o]).pipe(
      m(([{ height: i }, { offset: a, size: s }, { x: c, y: u }]) => ({
        offset: { x: a.x - c, y: a.y - u + i },
        size: s,
      }))
    );
  }
  function zo(e, { tx$: t }) {
    let r = y(e, "message").pipe(m(({ data: n }) => n));
    return t.pipe(
      _t(() => r, { leading: !0, trailing: !0 }),
      S((n) => e.postMessage(n)),
      Ot(r),
      ae()
    );
  ...
  var os = Q("#__config"),
    mt = JSON.parse(os.textContent);
  mt.base = `${new URL(mt.base, Se())}`;
  function me() {
    return mt;
  }
  function ce(e) {
  ...
  function ee(e, t) {
    return typeof t != "undefined"
      ? mt.translations[e].replace("#", t.toString())
      : mt.translations[e];
  }
    ...
    return (
      ...
      A(
        ...
        A(
          ...
          r > 0 && A("div", { class: "md-search-result__icon md-icon" }),
          A("h1", { class: "md-search-result__title" }, e.title),
          n > 0 &&
            e.text.length > 0 &&
            A("p", { class: "md-search-result__teaser" }, ko(e.text, 320)),
          e.tags && e.tags.map((a) => A("span", { class: "md-tag" }, a)),
          n > 0 &&
            o.length > 0 &&
            A(
              "p",
  ...
  function Ko(e) {
    ...
    return A("li", { class: "md-search-result__item" }, c);
  }
  function Yo(e) {
    return A(
      "ul",
  ...
  function is(e) {
    ...
    return A(
      ...
      A("a", { href: r.toString(), class: "md-version__link" }, e.title)
    );
  }
  function Go(e, t) {
    return A(
      ...
      A("ul", { class: "md-version__list" }, e.map(is))
    );
  }
  function as(e, t) {
    let r = P(() => B([ho(e), or(t)])).pipe(
      m(([{ x: n, y: o }, i]) => {
        let { width: a } = Ce(e);
  ...
  function Jo(e, t) {
    return P(() => {
      ...
      r.subscribe({
        next({ offset: i }) {
          e.style.setProperty("--md-tooltip-x", `${i.x}px`),
            e.style.setProperty("--md-tooltip-y", `${i.y}px`);
        },
        complete() {
        ...
        r
          ...
          .subscribe({
            next(i) {
              i
                ? e.style.setProperty("--md-tooltip-0", `${-i}px`)
      ...
      let n = Q(":scope > :last-child", e),
        o = y(n, "mousedown", { once: !0 });
      return (
        r
          .pipe(
            x(({ active: i }) => (i ? o : z)),
  ...
  function Zo(e, t, { print$: r }) {
    ...
    return n.size === 0
      ...
      : P(() => {
          let o = new O();
          return (
            r.pipe(se(o.pipe(pe(1)))).subscribe((i) => {
              e.hidden = !i;
              for (let [a, s] of n) {
                let c = Q(".md-typeset", s),
                  u = Q(`li:nth-child(${a})`, e);
                i ? Xo(c, u) : Xo(u, c);
              }
            }),
            C(...[...n].map(([, i]) => Jo(i, t))).pipe(
              L(() => o.complete()),
              ae()
            )
          );
  ...
  function ei(e) {
    return ve(e).pipe(
      m(({ width: t }) => ({ scrollable: cr(e).width > t })),
      J("scrollable")
    );
  }
  function ni(e, t) {
    let { matches: r } = matchMedia("(hover)"),
      n = P(() => {
        ...
        if (
          ...
          let a = e.closest("pre");
          (a.id = `__code_${++cs}`), a.insertBefore(Qo(a.id), e);
        }
        let i = e.closest(
          [":not(td):not(.code) > .highlight", ".highlighttable"].join(", ")
        );
        if (i instanceof HTMLElement) {
          let a = ri(i);
          if (
            typeof a != "undefined" &&
            (i.classList.contains("annotate") || ce("content.code.annotate"))
          ) {
            let s = Zo(a, e, t);
            return ei(e).pipe(
              S((c) => o.next(c)),
  ...
  function ps() {
    return typeof mermaid == "undefined" || mermaid instanceof Element
      ? Fo("https://unpkg.com/mermaid@8.13.3/dist/mermaid.min.js")
      : H(void 0);
  }
  function ii(e) {
    return (
      ...
      Gr ||
        (Gr = ps().pipe(
          S(() => mermaid.initialize({ startOnLoad: !1, themeCSS: oi })),
          Z(void 0),
          X(1)
        )),
      Gr.subscribe(() => {
  ...
  function ls(e, { target$: t, print$: r }) {
    let n = !0;
    return C(
      t.pipe(
        m((o) => o.closest("details:not([open])")),
        T((o) => e === o),
        Z({ action: "open", reveal: !0 })
      ),
      r.pipe(
        T((o) => o || !n),
        S(() => (n = e.open)),
  ...
  var si = A("table");
  function ci(e) {
    return e.replaceWith(si), si.replaceWith(Bo(e)), H({ ref: e });
  }
  function ms(e) {
    let t = G(":scope > input", e);
    return C(
      ...t.map((r) =>
        y(r, "change").pipe(Z({ active: Q(`label[for=${r.id}]`) }))
      )
    ).pipe(q({ active: Q(`label[for=${t[0].id}]`) }));
  }
  function ui(e) {
          ...
          .subscribe({
            next([{ active: n }]) {
              ...
              e.style.setProperty("--md-indicator-x", `${o.x}px`),
                ...
                t.scrollTo({ behavior: "smooth", left: o.x });
            },
            complete() {
  ...
  function fi(e, { target$: t, print$: r }) {
    return C(
      ...G("pre:not(.mermaid) > code", e).map((n) => ni(n, { print$: r })),
      ...G("pre.mermaid", e).map((n) => ii(n)),
      ...G("table:not([class])", e).map((n) => ci(n)),
      ...G("details", e).map((n) => ai(n, { target$: t, print$: r })),
      ...G("[data-tabs]", e).map((n) => ui(n))
    );
  }
  function ds(e, { alert$: t }) {
    return t.pipe(
      x((r) =>
        C(H(!0), H(!1).pipe(Ie(2e3))).pipe(
    ...
    return P(() => {
      ...
      return (
        n.subscribe(({ message: o, active: i }) => {
          (r.textContent = o),
            i
              ? e.setAttribute("data-md-state", "open")
  ...
  function hs({ viewport$: e }) {
    if (!ce("header.autohide")) return H(!1);
    let t = e.pipe(
        m(({ offset: { y: o } }) => o),
        Me(2, 1),
        m(([o, i]) => [o < i, i]),
      ...
      r = B([e, t]).pipe(
        T(([{ offset: o }, [, i]]) => Math.abs(i - o.y) > 100),
        m(([, [o]]) => o),
        Y()
      ),
      n = lt("search");
  ...
  function li(e, t) {
    return P(() => {
      ...
      return H(r.position === "sticky" || r.position === "-webkit-sticky");
    }).pipe(
      Ve(ve(e), hs(t)),
      m(([r, { height: n }, o]) => ({
        height: r ? n : 0,
  ...
  function mi(e, { header$: t, main$: r }) {
    return P(() => {
      ...
      return (
        n
          .pipe(J("active"), Ve(t))
          .subscribe(([{ active: o }, { hidden: i }]) => {
            o
              ? e.setAttribute("data-md-state", i ? "hidden" : "shadow")
              : e.removeAttribute("data-md-state");
          }),
        r.subscribe(n),
        t.pipe(
  ...
  function di(e, t) {
    return P(() => {
      ...
      r.subscribe(({ active: o }) => {
        o
          ? e.setAttribute("data-md-state", "active")
          : e.removeAttribute("data-md-state");
      });
      let n = ue("article h1");
    ...
    return B([n, o, t]).pipe(
      m(
        ([
          ...
          (u = Math.max(0, u - Math.max(0, a - c, i) - Math.max(0, u + c - s))),
          { offset: a - i, height: u, active: a - i <= c }
        )
      ),
      Y(
        (i, a) =>
      ...
      new k((t) => {
        new Jr.default("[data-clipboard-target], [data-clipboard-text]", {
          text: (r) =>
            ...
            gs(Q(r.getAttribute("data-clipboard-target"))),
  ...
  function dr(e) {
    ...
    if (t) return H(t);
    {
      ...
      return jo(new URL("sitemap.xml", e || r.base)).pipe(
        m((n) => ys(G("loc", n).map((o) => o.textContent))),
        Pe([]),
  ...
  function gi({ document$: e, location$: t, viewport$: r }) {
    ...
    "scrollRestoration" in history &&
      ...
      y(window, "beforeunload").subscribe(() => {
        history.scrollRestoration = "auto";
      }));
    let o = ue("link[rel=icon]");
    typeof o != "undefined" && (o.href = o.href);
    let i = dr().pipe(
        m((u) => u.map((f) => `${new URL(f, n.base)}`)),
        x((u) =>
          y(document.body, "click").pipe(
            T((f) => !f.metaKey && !f.ctrlKey),
            x((f) => {
                ...
                if (p && !p.target) {
                  ...
                  if (
                    ...
                    l.pathname !== location.pathname &&
                      u.includes(l.toString()))
                  )
                    return f.preventDefault(), H({ url: new URL(p.href) });
                }
              }
              return xe;
            })
      ...
      a = y(window, "popstate").pipe(
        T((u) => u.state !== null),
        m((u) => ({ url: new URL(location.href), offset: u.state })),
        ae()
      );
    C(i, a)
      .pipe(
        Y((u, f) => u.url.href === f.url.href),
        m(({ url: u }) => u)
      )
      .subscribe(t);
    let s = t.pipe(
      J("pathname"),
      x((u) => lr(u.href).pipe(De(() => (fr(u), xe)))),
      ae()
    );
    i.pipe(ft(s)).subscribe(({ url: u }) => {
      history.pushState({}, "", `${u}`);
    });
    let c = new DOMParser();
    s
      .pipe(
        x((u) => u.text()),
        m((u) => c.parseFromString(u, "text/html"))
      )
      .subscribe(e),
      e.pipe($e(1)).subscribe((u) => {
        for (let f of [
          "title",
          "link[rel=canonical]",
          "meta[name=author]",
          ...
          ...(ce("navigation.tabs.sticky") ? ["[data-md-component=tabs]"] : []),
        ]) {
          let p = ue(f),
            l = ue(f, u);
          typeof p != "undefined" &&
      ...
      e
        .pipe(
          ...
          $r((u) => {
            let f = A("script");
            if (u.src) {
              for (let p of u.getAttributeNames())
                f.setAttribute(p, u.getAttribute(p));
              return (
                u.replaceWith(f),
                new k((p) => {
                  f.onload = () => p.complete();
            ...
            } else return (f.textContent = u.textContent), u.replaceWith(f), z;
          })
        )
        .subscribe(),
      C(i, a)
        .pipe(ft(e))
        .subscribe(({ url: u, offset: f }) => {
          u.hash && !f
            ? Po(u.hash)
            : window.scrollTo(0, (f == null ? void 0 : f.y) || 0);
        }),
      r.pipe(Et(i), Je(250), J("offset")).subscribe(({ offset: u }) => {
        history.replaceState(u, "");
      }),
      C(i, a)
        .pipe(
          Me(2, 1),
          T(([u, f]) => u.url.pathname === f.url.pathname),
          m(([, u]) => u)
        )
        .subscribe(({ offset: u }) => {
  ...
  function Oi({ document$: e }) {
    let t = me(),
      r = Re(new URL("../versions.json", t.base)),
      n = r.pipe(
        m((o) => {
          let [, i] = t.base.match(/([^/]+)\/?$/);
          return (
    ...
    B([r, n])
        ...
        m(
          ([o, i]) =>
            new Map(
              o
                .filter((a) => a !== i)
                .map((a) => [`${new URL(`../${a.version}/`, t.base)}`, a])
            )
        ),
        x((o) =>
          y(document.body, "click").pipe(
            T((i) => !i.metaKey && !i.ctrlKey),
            x((i) => {
              if (i.target instanceof Element) {
                let a = i.target.closest("a");
                if (a && !a.target && o.has(a.href))
                  return i.preventDefault(), H(a.href);
              }
              return z;
            }),
            x((i) => {
      ...
      e.pipe(Ot(n)).subscribe((o) => {
        ...
        if (i) for (let s of oe("outdated")) s.hidden = !1;
      });
  }
  function _s(e, { rx$: t }) {
    ...
    let i = nr(e),
      a = C(y(e, "keyup"), y(e, "focus").pipe(Ie(1)), o).pipe(
        m(() => r(e.value)),
        q(""),
        Y()
      );
  ...
  function _i(e, { tx$: t, rx$: r }) {
    ...
    return (
      n
        .pipe(
          J("value"),
          m(({ value: o }) => ({ type: 2, data: o }))
        )
        .subscribe(t.next.bind(t)),
      n.pipe(J("focus")).subscribe(({ focus: o }) => {
        o
          ? (qe("search", o), (e.placeholder = ""))
  ...
  function Ti(e, { rx$: t }, { query$: r }) {
    let n = new O(),
      o = Mo(e.parentElement).pipe(T(Boolean)),
      i = Q(":scope > :first-child", e),
      a = Q(":scope > :last-child", e),
      s = t.pipe(T(dt), re(1));
    return (
      n.pipe(Le(r), Et(s)).subscribe(([{ items: u }, { value: f }]) => {
        if (f)
          switch (u.length) {
            case 0:
            ...
            case 1:
              ...
              break;
            default:
              i.textContent = ee("search.result.other", pr(u.length));
          }
      ...
      n
        ...
        .subscribe((u) => a.appendChild(Ko(u))),
      t
        .pipe(
          T(ht),
          m(({ data: u }) => u)
  ...
  function Mi(e, t) {
    ...
    return (
      ...
      y(e, "click").subscribe((n) => n.preventDefault()),
      Ts(e, t).pipe(
        S((n) => r.next(n)),
        L(() => r.complete()),
        m((n) => $({ ref: e }, n))
  ...
  function Li(e, { rx$: t }, { keyboard$: r }) {
    let n = new O(),
      o = we("search-query"),
      i = C(y(o, "keydown"), y(o, "focus")).pipe(
        Be(ge),
        m(() => o.value),
        Y()
      );
    return (
      n
        .pipe(
          ...
          m(([{ suggestions: s }, c]) => {
            let u = c.split(/([\s-]+)/);
            if ((s == null ? void 0 : s.length) && u[u.length - 1]) {
              let f = s[s.length - 1];
      ...
      r.pipe(T(({ mode: s }) => s === "search")).subscribe((s) => {
        switch (s.type) {
          case "ArrowRight":
            e.innerText.length &&
  ...
  function Ai(e, { index$: t, keyboard$: r }) {
    ...
    try {
      let o = (__search == null ? void 0 : __search.worker) || n.search,
        ...
        { tx$: c, rx$: u } = i;
      c.pipe(T(wi), ft(u.pipe(T(dt))), re(1)).subscribe(c.next.bind(c)),
        r.pipe(T(({ mode: l }) => l === "search")).subscribe((l) => {
          let d = Ne();
          switch (l.type) {
            case "Enter":
              if (d === a) {
                let h = new Map();
                for (let b of G(":first-child [href]", s)) {
                  let F = b.firstElementChild;
                  h.set(b, parseFloat(F.getAttribute("data-md-score")));
                }
                if (h.size) {
                  let [[b]] = [...h].sort(([, F], [, K]) => K - F);
                  b.click();
                }
                l.claim();
              }
        ...
        r.pipe(T(({ mode: l }) => l === "global")).subscribe((l) => {
          switch (l.type) {
            case "f":
            case "s":
            case "/":
      ...
      return C(f, p).pipe(
        Xe(
          ...oe("search-share", e).map((l) => Mi(l, { query$: f })),
          ...oe("search-suggest", e).map((l) => Li(l, i, { keyboard$: r }))
        )
      );
    } catch (o) {
  ...
  function Ci(e, { index$: t, location$: r }) {
    return B([
      ...
      r.pipe(
        q(Se()),
        T((n) => !!n.searchParams.get("h"))
      ),
    ]).pipe(
      m(([n, o]) => Zr(n.config, !0)(o.searchParams.get("h"))),
      m((n) => {
        var a;
        let o = new Map(),
        ...
        for (let s = i.nextNode(); s; s = i.nextNode())
          if ((a = s.parentElement) != null && a.offsetHeight) {
            let c = s.textContent,
              u = n(c);
            u.length > c.length && o.set(s, u);
          }
        for (let [s, c] of o) {
          let { childNodes: u } = A("span", null, c);
          s.replaceWith(...Array.from(u));
        }
        return { ref: e, nodes: o };
      })
    );
  }
  function Ms(e, { viewport$: t, main$: r }) {
  ...
  function en(e, n) {
    ...
    return P(() => {
      let s = new O();
      return (
        s.pipe(He(0, Te), Le(t)).subscribe({
          next([{ height: c }, { height: u }]) {
            (i.style.height = `${c - 2 * a}px`), (e.style.top = `${u}px`);
          },
          complete() {
  ...
  function As(e) {
    return (
      ...
      (Ls = P(() => {
        ...
        return t
          ? H(t)
          : Hi(e.href).pipe(S((r) => __md_set("__source", r, sessionStorage)));
      }).pipe(
        De(() => z),
  ...
  function Pi(e) {
    ...
    return P(() => {
      ...
      return (
        r.subscribe(({ facts: n }) => {
          t.appendChild(Yo(n)), t.setAttribute("data-md-state", "done");
        }),
        As(e).pipe(
          S((n) => r.next(n)),
          L(() => r.complete()),
  ...
  function Cs(e, { viewport$: t, header$: r }) {
    ...
    return P(() => {
      ...
      return (
        r.subscribe({
          next({ hidden: n }) {
            n
              ? e.setAttribute("data-md-state", "hidden")
              : e.removeAttribute("data-md-state");
          },
          complete() {
            e.removeAttribute("data-md-state");
        ...
        (ce("navigation.tabs.sticky") ? H({ hidden: !1 }) : Cs(e, t)).pipe(
          S((n) => r.next(n)),
          L(() => r.complete()),
          m((n) => $({ ref: e }, n))
        )
  ...
  function Rs(e, { viewport$: t, header$: r }) {
    ...
    for (let s of o) {
      let c = decodeURIComponent(s.hash.substring(1)),
        u = ue(`[id="${c}"]`);
      typeof u != "undefined" && n.set(s, u);
    }
    let i = r.pipe(
      J("height"),
      m(({ height: s }) => {
        let c = we("main"),
          u = Q(":scope > :first-child", c);
        return s + 0.8 * (u.offsetTop - c.offsetTop);
      }),
      ae()
    );
    return ve(document.body)
          ...
          P(() => {
            ...
            return H(
              [...n].reduce((u, [f, p]) => {
                ...
                return u.set([...(c = [...c, f])].reverse(), l);
              }, new Map())
            );
          }).pipe(
            m((c) => new Map([...c].sort(([, u], [, f]) => u - f))),
            Ve(i),
            x(([c, u]) =>
              t.pipe(
                Fr(
                  ([f, p], { offset: { y: l }, size: d }) => {
                    let h = l + d.height >= Math.floor(s.height);
                    for (; p.length; ) {
                      let [, b] = p[0];
                      if (b - u < l || h) f = [...f, p.shift()];
                      else break;
                    }
                    for (; f.length; ) {
                      let [, b] = f[f.length - 1];
                      if (b - u >= l && !h) p = [f.pop(), ...p];
                      else break;
                    }
                    return [f, p];
                  },
      ...
      .pipe(
        m(([s, c]) => ({ prev: s.map(([u]) => u), next: c.map(([u]) => u) })),
        q({ prev: [], next: [] }),
        Me(2, 1),
        m(([s, c]) =>
  ...
  function $i(e, { viewport$: t, header$: r, target$: n }) {
    return P(() => {
      let o = new O();
      return (
        o.subscribe(({ prev: i, next: a }) => {
          for (let [s] of a)
            s.removeAttribute("data-md-state"),
              s.classList.remove("md-nav__link--active");
          for (let [s, [c]] of i.entries())
            c.setAttribute("data-md-state", "blur"),
              c.classList.toggle("md-nav__link--active", s === i.length - 1);
        }),
        ce("navigation.tracking") &&
          t
            .pipe(
              se(o.pipe(pe(1))),
              J("offset"),
  ...
  function ks(e, { viewport$: t, main$: r, target$: n }) {
    let o = t.pipe(
        m(({ offset: { y: a } }) => a),
        Me(2, 1),
        m(([a, s]) => a > s && s > 0),
  ...
  function ji(e, { viewport$: t, header$: r, main$: n, target$: o }) {
    ...
    return (
      ...
      r
        .pipe(se(i.pipe(rr(0), pe(1))), J("height"))
        .subscribe(({ height: a }) => {
          e.style.top = `${a + 16}px`;
        }),
      ks(e, { viewport$: t, main$: n, target$: o }).pipe(
        S((a) => i.next(a)),
        L(() => i.complete()),
        m((a) => $({ ref: e }, a))
      )
  ...
  function Fi({ document$: e, tablet$: t }) {
    e.pipe(
      x(() => G("[data-md-state=indeterminate]")),
      S((r) => {
        (r.indeterminate = !0), (r.checked = !1);
      }),
      ie((r) =>
        y(r, "change").pipe(
          Wr(() => r.hasAttribute("data-md-state")),
          Z(r)
        )
      ),
      Le(t)
  ...
  function Ui({ document$: e }) {
    e.pipe(
      x(() => G("[data-md-scrollfix]")),
      S((t) => t.removeAttribute("data-md-scrollfix")),
      T(Hs),
      ie((t) => y(t, "touchstart").pipe(Z(t)))
    ).subscribe((t) => {
      let r = t.scrollTop;
      r === 0
        ? (t.scrollTop = 1)
  ...
  var Ze = mo(),
    ...
    qi = document.forms.namedItem("search")
      ? (__search == null ? void 0 : __search.index) ||
        Re(new URL("search/search_index.json", zi.base))
      : xe,
    rn = new O();
  vi({ alert$: rn });
  ce("navigation.instant") &&
    gi({ document$: Ze, location$: br, viewport$: Ee });
  var Di;
  ((Di = zi.version) == null ? void 0 : Di.provider) === "mike" &&
    Oi({ document$: Ze });
  C(br, Mt)
    .pipe(Ie(125))
    .subscribe(() => {
  ...
  tn.pipe(T(({ mode: e }) => e === "global")).subscribe((e) => {
    switch (e.type) {
      case "p":
      case ",":
        let t = ue("[href][rel=prev]");
        typeof t != "undefined" && t.click();
        break;
      case "n":
      case ".":
        let r = ue("[href][rel=next]");
        typeof r != "undefined" && r.click();
        break;
    }
  });
  Fi({ document$: Ze, tablet$: vr });
  Ui({ document$: Ze });
  Wi({ viewport$: Ee, tablet$: vr });
  var Qe = li(we("header"), { viewport$: Ee }),
    ...
    Ps = C(
      ...oe("dialog").map((e) => pi(e, { alert$: rn })),
      ...oe("header").map((e) =>
        mi(e, { viewport$: Ee, header$: Qe, main$: hr })
      ),
      ...oe("palette").map((e) => bi(e)),
      ...oe("search").map((e) => Ai(e, { index$: qi, keyboard$: tn })),
      ...oe("source").map((e) => Pi(e))
    ),
    Is = P(() =>
      C(
        ...oe("content").map((e) => fi(e, { target$: Mt, print$: Ni })),
        ...oe("content").map((e) =>
          ce("search.highlight") ? Ci(e, { index$: qi, location$: br }) : z
        ),
        ...oe("header-title").map((e) => di(e, { viewport$: Ee, header$: Qe })),
        ...oe("sidebar").map((e) =>
          e.getAttribute("data-md-type") === "navigation"
            ? Qr(Vi, () => en(e, { viewport$: Ee, header$: Qe, main$: hr }))
            : Qr(vr, () => en(e, { viewport$: Ee, header$: Qe, main$: hr }))
        ),
        ...oe("tabs").map((e) => Ii(e, { viewport$: Ee, header$: Qe })),
        ...oe("toc").map((e) =>
          $i(e, { viewport$: Ee, header$: Qe, target$: Mt })
        ),
        ...oe("top").map((e) =>
          ji(e, { viewport$: Ee, header$: Qe, main$: hr, target$: Mt })
        )
      )
    ),
    Qi = Ze.pipe(
