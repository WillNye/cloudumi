...
GITHUB_APP_NOQ_WEBHOOK_SNS_TOPIC_ARN = os.environ[
    "GITHUB_APP_NOQ_WEBHOOK_SNS_TOPIC_ARN"
]
# Example format: "arn:aws:sns:us-east-2:444455556666:MyTopic"
topic_region = GITHUB_APP_NOQ_WEBHOOK_SNS_TOPIC_ARN.split(":")[3]
...
def verify_signature(sig: str, payload: str) -> None:
    good_sig = calculate_signature(GITHUB_APP_NOQ_WEBHOOK_SECRET, payload)
...
def lambda_handler(event, context):
    ...
    _ = sns.publish(
        TopicArn=GITHUB_APP_NOQ_WEBHOOK_SNS_TOPIC_ARN,
