...
class Aws:
    ...
    def _add_role_to_redis(self, role_entry: dict, host: str):
    ...
    def _fetch_role_from_redis(self, role_arn: str, host: str):
    ...
    async def fetch_iam_user(
        ...
        try:
            ...
            if run_sync:
                ...
                user = await self._get_iam_user_async(account_id, user_name, conn, host)
    ...
    async def fetch_iam_role(
        ...
        await sync_to_async(self._add_role_to_redis)(result, host)
