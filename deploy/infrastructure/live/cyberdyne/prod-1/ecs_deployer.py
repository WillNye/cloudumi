...
kms_key_arn = "arn:aws:kms:us-west-2:775726381634:key/1c395f1c-3e48-447f-adfe-f9dc55f5c57e"
...
for task in task_details["tasks"]:
    ...
    print(f"AWS_PROFILE={os.environ['AWS_PROFILE']} ecs-cli logs --region {region} --task-id {task_id} -c {cluster_name} --follow\n")