...
resource "aws_subnet" "subnet_private_az0-tgw" {
  vpc_id            = aws_vpc.main_vpc.id
  cidr_block        = "10.${var.attributes}.192.0/28"
  availability_zone = element(var.subnet_azs, 0)

  tags = {
    "Name"        = "noq.internal.akasa.engineering-tgw",
...
resource "aws_subnet" "subnet_private_az1-tgw" {
  vpc_id            = aws_vpc.main_vpc.id
  cidr_block        = "10.${var.attributes}.193.0/28"
  availability_zone = element(var.subnet_azs, 1)
