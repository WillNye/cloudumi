...
const Tabs = ({ selectedTab, setSelectedTab }) => {
  return (
    <Segment basic>
      <Step.Group fluid>
        <Step
          active={selectedTab === TABS_ENUM.STEP_ONE}
          onClick={() => setSelectedTab(TABS_ENUM.STEP_ONE)}
          className={'step1'}
        >
          <Icon name='handshake' />
          <Step.Content>
        ...
        <Step
          active={selectedTab === TABS_ENUM.STEP_TWO}
          onClick={() => setSelectedTab(TABS_ENUM.STEP_TWO)}
          className={`step2`}
        >
        ...
        <Step
          active={selectedTab === TABS_ENUM.STEP_THREE}
          onClick={() => setSelectedTab(TABS_ENUM.STEP_THREE)}
          className={'step3'}
        >
          <Icon name='handshake' />
          <Step.Content>
