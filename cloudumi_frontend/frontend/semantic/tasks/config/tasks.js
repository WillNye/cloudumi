...
var hasBrowserslistConfig =
  JSON.stringify(defaultBrowsers) !== JSON.stringify(userBrowsers);

var overrideBrowserslist = hasBrowserslistConfig
  ? undefined
  : ["last 2 versions", "> 1%", "opera 12.1", "bb 10", "android 4"];
