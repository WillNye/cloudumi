...
class AccessDeniedReason(str, enum.Enum):
    ...
    PERMISSIONS_BOUNDARY_EXPLICIT_DENY = (
        "Explicit deny in a permissions boundary policy"
    )
    PERMISSIONS_BOUNDARY_MISSING_ALLOW = (
        "Missing allow in a permissions boundary policy"
    )
