...
#   timestamp: 2022-04-19T21:01:04+00:00
...
class Account(BaseModel):
    id: str = Field(..., description="The account id", example=111118675309)
    name: str = Field(..., description="The account name", example="development")
