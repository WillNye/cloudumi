...
#   timestamp: 2022-03-15T21:55:44+00:00
...
class SSOIDPProviders(BaseModel):
    google_oidc_sso_idp_provider: Optional[GoogleOIDCSSOIDPProvider] = None
    saml_oidc_sso_idp_provider: Optional[SamlOIDCSSOIDPProvider] = None
    oidc_sso_idp_provider: Optional[OIDCSSOIDPProvider] = None
