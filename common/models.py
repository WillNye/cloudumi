...
#   timestamp: 2022-03-17T16:35:02+00:00
...
class CognitoUser(BaseModel):
    ...
    desired_delivery_medium: Optional[str] = Field(
        None,
        description="EMAIL or SMS, while the boto3 API supports multiple, we only support one",
    )
