...
#   timestamp: 2023-01-04T20:04:25+00:00
...
class IambicRepoConfig(BaseModel):
    repo_name: str = Field(
        ..., description="The name of the repository that has the IambicRepo"
    )
    access_token: str = Field(
        ..., description="The access token that provides repo access to the IambicRepo"
    )
