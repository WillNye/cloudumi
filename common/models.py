...
#   timestamp: 2022-06-15T12:50:38+00:00
...
class HubAccount(BaseModel):
    ...
    read_only: Optional[bool] = Field(
        False,
        description="Optional value (defaults to false) to indicate whether Noq has the ability to modify resources on any spoke account.",
    )
...
class CloudtrailDetection(BaseModel):
    host: Optional[str] = Field(None, description="TODO")
