...
#   timestamp: 2022-03-15T01:10:44+00:00
...
class GoogleOIDCSSOIDPProvider(BaseModel):
    ...
    provider_type: ProviderType = Field(..., description="The identity provider type.")
...
class SamlOIDCSSOIDPProvider(BaseModel):
    ...
    provider_name: str = Field(..., description="The identity provider name.")
    provider_type: ProviderType1 = Field(..., description="The identity provider type.")
    user_pool_id: constr(regex=r"[\w-]+_[0-9a-zA-Z]+") = Field(
...
class OIDCSSOIDPProvider(BaseModel):
    ...
    provider_name: str = Field(..., description="The identity provider name.")
    provider_type: ProviderType2 = Field(..., description="The identity provider type.")
    user_pool_id: constr(regex=r"[\w-]+_[0-9a-zA-Z]+") = Field(
        ..., description="The user pool ID."
    )
