...
#   timestamp: 2022-05-05T13:29:08+00:00
...
class TearRoleChangeModel(ChangeModel):
    ...
    role_arn: Optional[
        ...
        None,
        description="Role to temporarily assume",
...
class RequestModel(BaseModel):
    ...
    is_tear: Optional[bool] = Field(
        False, description="Is this a temporary elevated access request"
    )
