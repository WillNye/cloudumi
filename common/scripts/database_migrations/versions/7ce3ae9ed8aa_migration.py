...
def upgrade() -> None:
    ...
    op.create_index(
        op.f(
            "ix_iambic_template_provider_defs_express_access_request_association_express_access_request_id"
        ),
        "iambic_template_provider_defs_express_access_request_association",
        ["express_access_request_id"],
        unique=False,
    ...
    op.add_column(
        "request_type",
        sa.Column("express_request_support", sa.Boolean(), nullable=True),
    )
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column("request_type", "express_request_support")
    op.add_column(
        "request_type",
        sa.Column(
    ...
    op.drop_index(
        ...
        table_name="iambic_template_provider_defs_express_access_request_association",
    )
